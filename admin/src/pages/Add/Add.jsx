            ...
            <div className="add-category-price ">
                <div className="add-category flex-col">
                    ...
                    <select onChange={onChnageHandler} value={data.category} name="category" >
                        <option vlaue="Salad">Salad</option>
                        <option vlaue="Roles">Roles</option>
                        <option vlaue="Deserts">Deserts</option>
                        <option vlaue="Sandwich">Sandwich</option>
                        <option vlaue="Cake">Cake</option>
                        <option vlaue="Pure Veg">Pure Veg</option>
                        <option vlaue="Pasta">Pasta</option>
                        <option vlaue="Noodles">Noodels</option>
                    </select>
                </div>
